...
public class Restaurant
{
	...
	public static void main(String[] argv) {
		...
		try {
			...
			int choice = 0;
			do {
				System.out.println("\n\nWelcome to Gotham Restaurant Rerservation System");
				...
				switch (choice) {
					...
					case 3:
						...
						makeReservations(connection, tableID, customerID, partySize);
						break;
//					case 4:
...
//						break;
	...
	public static void makeReservations(Connection connection, int tableID, int customerID, int partySize) throws SQLException {
		String query = "INSERT INTO RESERVATION (tID, cID, partySize, reservationDate) VALUES (" +
				tableID + "," + customerID + "," + partySize +", curdate())";
		try (Statement statement = connection.createStatement()) {
...
//	}
	...
	public static void printAllReservations(Connection connection) throws SQLException {
		...
		try (Statement statement = connection.createStatement()) {
			...
			System.out.println("Table ID	Customer ID		Party Size			Date");
			while (resultSet.next()) {
